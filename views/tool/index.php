                ...
                <div class="map-form">
                    <div class="map-form__grid">
                        <div class="map-form__main">
                            <form action="#">
                                <div class="form-group field-map-intro">
                                    <label class="control-label">Customer name</label>
                                    <select class="form-control">
                                        <option value="">Michael Ebanzu</option>
                                ...
                                <div class="form-group field-map-intro">
                                    <label class="control-label">Current Belief</label>
                                    <select class="form-control">
                                        <option value="">Disease area presents clinical problem in patient…</option>
                                        <option value="">2</option>
                                        <option value="">3</option>
                                        <option value="">4</option>
                                        <option value="">5</option>
                                ...
                                <div class="form-group field-map-intro">
                                    <label class="control-label">Current Practice</label>
                                    <select class="form-control">
                                        <option value="">Funds inadequate treatment only. No new approach..</option>
                                        <option value="">2</option>
                                        <option value="">3</option>
                                        <option value="">4</option>
                                        <option value="">5</option>
                                ...
                                <div class="form-group">
                                    <button type="submit" id="btn-submit" class="btn btn-info" disabled="">SUBMIT</button>
                                </div>
                            </form>
                        </div>
