...
<body class="d-flex flex-column h-100">
    ...
    <header class="page-header">
        <nav id="header-navbar" class="navbar navbar-expand-md navbar-dark bg-main navbar" style="background: #c3d500 !important;">
            <div class="container" style="max-width: 100% !important">
            <a class="navbar-brand" href="/web/index.php"><span style="color: #fff; font-size: 22px;">Administrators</span></a>
                ...
                <div class="map-form__grid is-revert">
                    <div class="map-preview map-form__aside">
                        ...
                        <div class="map-preview__inner is-new">
                            ...
                            <div class="row">
                                <div class="cell" style="background: #0E2F4A;">a3</div>
                                <div class="cell" style="background: #C3D502;">a2</div>
                                <div class="cell" style="background: #C3D502;">a1</div>
                                <div class="cell" style="background: #C3D502;">a1</div>
                            </div>
                    ...
                    <div class="map-form__main">
                        <div class="report-data-container">
                            ...
                            <div class="date-slider" style="margin-bottom: 20px;">
                                <div class="date-slider__start">Start  <span>2022-07-18</span></div>
                                <input type="range" class="date-slider__input js-date-slider" data-dates="2022-07-18" id="select-date" tabindex="-1" readonly="">
                                <div class="date-slider__end">Today<span>2022-07-18</span></div>
                            </div>
                            ...
                            <div class="scroll-area">
                                <div id="p0" data-pjax-container="" data-pjax-push-state="" data-pjax-timeout="1000">
                                    ...
                                    <table class="table table-striped table-bordered"><thead>
                                        <tr><th>Contact</th><th><a href="/web/index.php?r=map%2Freport&amp;id=2&amp;sort=cell_id" data-sort="cell_id">Position</a></th><th><a class="desc" href="/web/index.php?r=map%2Freport&amp;id=2&amp;sort=date_in" data-sort="date_in">Time at</a></th></tr>

                                        </thead>
                                        <tbody>
                                        <tr data-key="2"><td>iyu</td><td>A1</td><td>Jul 18, 2022 10:33:57 AM</td></tr>
                                        <tr data-key="2"><td>iyu</td><td>A1</td><td>Jul 18, 2022 10:33:57 AM</td></tr>
                                        <tr data-key="2"><td>iyu</td><td>A1</td><td>Jul 18, 2022 10:33:57 AM</td></tr>
                                        <tr data-key="2"><td>iyu</td><td>A1</td><td>Jul 18, 2022 10:33:57 AM</td></tr>
                                        </tbody></table>
    ...
    <script src="/web/assets/9d269bbd/jquery.js"></script>
    <script src="/web/assets/6e550a1c/yii.js"></script>
    <script src="/web/assets/1b984906/js/bootstrap.bundle.js"></script><script src="/web/plugins/scripts.js"></script>
    <script src="/web/plugins/jquery.scrollbar.min.js"></script>
    <script src="/web/plugins/ion.rangeSlider.min.js"></script>
